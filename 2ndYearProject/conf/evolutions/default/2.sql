...
values (100, 'Hardrive', 'This is a test product', 99.99, 17, 3, 5.5, 1);

insert into product (product_ID,product_name,product_description,product_price,product_qty,
total_sold,overall_rating, category_id) 
values (101, 'SSD', 'This is a test product', 99.99, 18, 2, 4.5,2);

insert into product (product_ID,product_name,product_description,product_price,product_qty,
total_sold,overall_rating, category_id) 
values (103, 'USB', 'This is a test product', 99.99, 16, 4, 2.3, 3);
